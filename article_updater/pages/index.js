...
export default function Home() {
  return (
    <div className="container">
      <Head>
        <title>rekt.news</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main>
        <h1 className="title">
          Welcome to <a href="https://rekt.news">rekt.news</a> Article Updater
        </h1>

        <div className="grid">
          <Article title="article 1" message="A got rekt" />
      ...
      <footer>Powered by CrazMar</footer>
